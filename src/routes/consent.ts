...
// PR-A2 (2026-06-07): DEV 토글 + dev-test/promote + rollback/stage* endpoint 완전 제거.
// 사유: 정식 동의 흐름(promoteToBothAgreed 공통 함수)과 분기점이 6개나 있어 검증 무의미.
// 정식 동의가 PR-A1 으로 단일화됐고 backfill 로 기존 데이터도 정합 완료(1317 sessions).
// 추후 dev 검증이 필요하면 정식 endpoint 를 그대로 호출 — 별도 분기 둘 이유 없음.
